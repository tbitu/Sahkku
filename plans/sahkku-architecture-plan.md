...
task_tracker:
  ...
  - task_id: 3-llm-agent-and-endpoint
    task_path: plans/tasks/3-llm-agent-and-endpoint.md
    status: draft
...
| `3-llm-agent-and-endpoint` | `plans/tasks/3-llm-agent-and-endpoint.md` | Implement `LlmPlayerAgent`, OpenAI/LM Studio REST client, structured JSON parser, retry loop, and heuristic fallback. | `2-match-controller-and-hotseat` | LLM NPC integration | draft |
